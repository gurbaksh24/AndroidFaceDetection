...
public class FaceDetectorEmployeeActivity extends AppCompatActivity {
    ...
    private void initializeItems() {
        preview = (FrameLayout) findViewById(R.id.employee_camera_preview);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_face_detector_employee);
    ...
    private void listenerCaller() {
        ...
        FloatingActionButton captureButton = findViewById(R.id.employee_button_capture);
            ...
            public void onStateChanged(int id, TransferState state) {
                ...
                if (state.toString().equals("COMPLETED")) {
                    if (response != null && !response.equals("\"No Match Found\"") && !response.equals("\"Exception Occurred\"")) {
                        Intent intent = new Intent(FaceDetectorEmployeeActivity.this, WelcomeEmployeeActivity.class);
                        intent.putExtra("Employee Name", response);
                        startActivity(intent);
                        Toast.makeText(FaceDetectorEmployeeActivity.this, "Face Recognised", Toast.LENGTH_SHORT).show();
                    } else {
                        Intent intent = new Intent(FaceDetectorEmployeeActivity.this, EmployeeNotFoundActivity.class);
                        startActivity(intent);
                        Toast.makeText(FaceDetectorEmployeeActivity.this, "Face Not Recognised", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    private boolean saveImageInDirectory(byte[] data) {
        ...
        if (!pictureFileDir.exists() && !pictureFileDir.mkdirs()) {
            ...
            Toast.makeText(FaceDetectorEmployeeActivity.this, "Can't create directory to save image.", Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        try {
            ...
            Toast.makeText(FaceDetectorEmployeeActivity.this, "Image could not be saved.", Toast.LENGTH_LONG).show();
            return false;
        }
    }
    ...
    private void logout() {
        ...
        editor.commit();
        Intent intent = new Intent(FaceDetectorEmployeeActivity.this, LoginActivity.class);
